	       ...
	       switch(menu) {
	          ...
	          case "2" :
	        	  ...
	        	  if(vo2.getPcode()==null) {
	        		  System.out.println(code2+"번 교수가 없음");
	        	  }else {
	          ...
	          case "3" :
	        	  for(ProVO v:dao.list()) {
	        		  ...
	        		  System.out.printf("%s\t%s\t%s\t%s\t%-10s\t%,10d원\n",
	        				  v.getPcode(),v.getPname(),dept,
	        				  title,date,v.getSalary());
	        	  }
	             break;
	          case "4" :
	        	  ...
	        	  if(vo4.getPcode()==null) {
	        		  System.out.println(code4 + "교수번호없음");
	        	  }else {
	        		  System.out.println(vo4.toString());
	        		  System.out.print(vo4.getPname()+"삭제하실래요(y)?");
